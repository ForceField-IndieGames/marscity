...
public enum Upgrade {
	...
	GarbageyardBurner(ResourceManager.TEXTURE_GUITHUMBGARBAGEYARD,Buildings.BUILDINGTYPE_GARBAGEYARD,1000,3),
	GarbageyardVehicles(ResourceManager.TEXTURE_GUITHUMBGARBAGEYARD,Buildings.BUILDINGTYPE_GARBAGEYARD,750,3),
	ServercenterServers(ResourceManager.TEXTURE_GUITHUMBSERVERCENTER,Buildings.BUILDINGTYPE_SERVERCENTER,900,2),
	CitycenterShield(ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER,Buildings.BUILDINGTYPE_CITYCENTER,15000,0),
	CitycenterShield2(ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER,Buildings.BUILDINGTYPE_CITYCENTER,50000,0,CitycenterShield);
