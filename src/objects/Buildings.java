...
public class Buildings{
	...
	public static void init()
	{
		...
		//Building Types:           INDEX                                            NAME                                            OBJECT                                   TEXTURE                                       THUMBNAIL                    GRIDCOLOR        BUILDINGCOST  MONTHLYCOST  WIDTH    DEPTH   HEIGHT  HAPPINESSEFFECT  HAPPINESSRADIUS  SUPPLY  NEEDED: ENERGY  HEALTH  GARBAGE  INTERNET  SECURITY                            
				...
				buildingTypes.add(  BUILDINGTYPE_RESEARCHSTATION, new BuildingType(  "BUILDINGTYPE_RESEARCHSTATION", ResourceManager.OBJECT_RESEARCHSTATION,  ResourceManager.TEXTURE_RESEARCHSTATION,      ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER, Color.RED,       7000,         10,          2,       2,      3,      0,               0,               0,              10,     0,      0,       0,        0        ));
				...
				buildingTypes.add(  BUILDINGTYPE_BANK,            new BuildingType(  "BUILDINGTYPE_BANK",            ResourceManager.OBJECT_BANK,             ResourceManager.TEXTURE_BANK,                 ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER, Color.RED,       5000,         10,          2,       2,      3,      0,               0,               0,              10,     0,      0,       0,        0        ));
				buildingTypes.add(  BUILDINGTYPE_MEDICALCENTER,   new BuildingType(  "BUILDINGTYPE_MEDICALCENTER",   ResourceManager.OBJECT_MEDICALCENTER,    ResourceManager.TEXTURE_MEDICALCENTER,        ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER, Color.BLUE,      10000,        15,          2,       2,      3,      10,              15,              500,            0,      0,      0,       0,        0        ));
				buildingTypes.add(  BUILDINGTYPE_SERVERCENTER,    new BuildingType(  "BUILDINGTYPE_SERVERCENTER",    ResourceManager.OBJECT_SERVERCENTER,     ResourceManager.TEXTURE_SERVERCENTER,         ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER, Color.BLUE,      10000,        10,          2,       2,      3,      0,               0,               1000,           0,      0,      0,       0,        0        ));
				buildingTypes.add(  BUILDINGTYPE_GARBAGEYARD,     new BuildingType(  "BUILDINGTYPE_GARBAGEYARD",     ResourceManager.OBJECT_GARBAGEYARD,      ResourceManager.TEXTURE_GARBAGEYARD,          ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER, Color.BLUE,      5000,         10,          2,       2,      3,      -20,             20,              1000,           0,      0,      0,       0,        0        ));
				...
				buildingTypes.add(  BUILDINGTYPE_SOLARPOWER,      new BuildingType(  "BUILDINGTYPE_SOLARPOWER",      ResourceManager.OBJECT_SOLARPOWER,       ResourceManager.TEXTURE_SOLARPOWER,           ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER, Color.YELLOW,    5000,         10,          2,       2,      3,      0,               0,               1000,           0,      0,      0,       0,        0        ));
