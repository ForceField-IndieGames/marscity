...
public class Buildings{
	...
	public static void init()
	{
		...
		//Building Types:           INDEX                                            NAME                                            OBJECT                                   TEXTURE                                       THUMBNAIL                      GRIDCOLOR        BUILDINGCOST  MONTHLYCOST  WIDTH    DEPTH   HEIGHT  HAPPINESSEFFECT  HAPPINESSRADIUS  SUPPLY  NEEDED: ENERGY  HEALTH  GARBAGE  INTERNET  SECURITY                            
				...
				buildingTypes.add(  BUILDINGTYPE_BANK,            new BuildingType(  "BUILDINGTYPE_BANK",            ResourceManager.OBJECT_BANK,             ResourceManager.TEXTURE_BANK,                 ResourceManager.TEXTURE_GUITHUMBBANK,          Color.RED,       5000,         10,          6,       4,      4,      0,               0,               0,              10,     0,      0,       0,        0        ));
