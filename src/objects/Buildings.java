...
public class Buildings{
	...
	public static void init()
	{
		...
		//Building Types:           INDEX                                            NAME                                            OBJECT                                   TEXTURE                                       THUMBNAIL                        GRIDCOLOR     LOCKEDCALLBACK    BUILDINGCOST  MONTHLYCOST  WIDTH    DEPTH   HEIGHT  HAPPINESSEFFECT  HAPPINESSRADIUS  TRANSACTIONCATEGORY              SUPPLY                    ->AMOUNT ->RADIUS  NEEDED: ENERGY  HEALTH  GARBAGE  INTERNET  SECURITY                            
				...
				buildingTypes.add(  BUILDINGTYPE_POLICE,          new BuildingType(  "BUILDINGTYPE_POLICE",          ResourceManager.OBJECT_POLICE,           ResourceManager.TEXTURE_POLICE,               ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER,     Color.BLUE,   null,             5500,         10,          2,       2,      3,      10,              15,              TransactionCategory.Police,      Supply.Security,          500,     30,               0,      0,      0,       0,        0        ));
