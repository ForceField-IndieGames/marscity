...
public class Buildings{
	...
	public static void init()
	{
		...
		//Building Types:           INDEX                                            NAME                                            OBJECT                                   TEXTURE                                       THUMBNAIL                        GRIDCOLOR        BUILDINGCOST  MONTHLYCOST  WIDTH    DEPTH   HEIGHT  HAPPINESSEFFECT  HAPPINESSRADIUS  T.CATEGORY                       SUPPLY                    ->AMOUNT ->RADIUS  NEEDED: ENERGY  HEALTH  GARBAGE  INTERNET  SECURITY                            
				buildingTypes.add(  BUILDINGTYPE_HOUSE,           new BuildingType(  "BUILDINGTYPE_HOUSE",           ResourceManager.OBJECT_HOUSE,            ResourceManager.TEXTURE_HOUSE,                ResourceManager.TEXTURE_GUITHUMBHOUSE,           Color.GREEN,     250,          0,           2,       2,      1.5f,   0,               0,               null,                            null,                     0,       0,       10,     10,     10,      10,       10       ));
				buildingTypes.add(  BUILDINGTYPE_BIGHOUSE,        new BuildingType(  "BUILDINGTYPE_BIGHOUSE",        ResourceManager.OBJECT_BIGHOUSE,         ResourceManager.TEXTURE_BIGHOUSE,             ResourceManager.TEXTURE_GUITHUMBBIGHOUSE,        Color.GREEN,     1500,         0,           4,       4,      8,      0,               0,               null,                            null,                     0,       0,       50,     50,     50,      50,       50       ));
				...
				buildingTypes.add(  BUILDINGTYPE_MEDICALCENTER,   new BuildingType(  "BUILDINGTYPE_MEDICALCENTER",   ResourceManager.OBJECT_MEDICALCENTER,    ResourceManager.TEXTURE_MEDICALCENTER,        ResourceManager.TEXTURE_GUITHUMBMEDICALCENTER,   Color.BLUE,      10000,        15,          6,       4,      3,      10,              15,              TransactionCategory.Health,      Supply.Health,            500,     30,      0,      0,      0,       0,        0        ));
				buildingTypes.add(  BUILDINGTYPE_SERVERCENTER,    new BuildingType(  "BUILDINGTYPE_SERVERCENTER",    ResourceManager.OBJECT_SERVERCENTER,     ResourceManager.TEXTURE_SERVERCENTER,         ResourceManager.TEXTURE_GUITHUMBSERVERCENTER,    Color.BLUE,      10000,        10,          8,       8,      3,      0,               0,               TransactionCategory.Other,       Supply.Internet,          1000,    0,       0,      0,      0,       0,        0        ));
				...
				buildingTypes.add(  BUILDINGTYPE_POLICE,          new BuildingType(  "BUILDINGTYPE_POLICE",          ResourceManager.OBJECT_POLICE,           ResourceManager.TEXTURE_POLICE,               ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER,     Color.BLUE,      15000,        15,          2,       2,      3,      10,              15,              TransactionCategory.Police,      Supply.Security,          500,     30,      0,      0,      0,       0,        0        ));
