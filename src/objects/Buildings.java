...
public class Buildings{
	...
	public static void init()
	{
		...
		//Building Types:           INDEX                                            NAME                                            OBJECT                              TEXTURE                              THUMBNAIL                    BUILDINGCOST  MONTHLYCOST  WIDTH    DEPTH   HEIGHT  SUPPLY  NEEDED: ENERGY  HEALTH  GARBAGE  INTERNET  SECURITY                            
				...
				buildingTypes.add(  BUILDINGTYPE_CITYCENTER,      new BuildingType(  "BUILDINGTYPE_CITYCENTER",      ResourceManager.OBJECT_CITYCENTER,  ResourceManager.TEXTURE_CITYCENTER,  ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER, 0,            0,           8,       8,      6,      0,              0,      0,      0,       0,        0        ));
