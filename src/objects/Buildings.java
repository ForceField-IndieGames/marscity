...
public class Buildings{
	...
	public static void init()
	{
		...
		//Building Types:           INDEX                                            NAME                                            OBJECT                              TEXTURE                              THUMBNAIL                    GRIDCOLOR        BUILDINGCOST  MONTHLYCOST  WIDTH    DEPTH   HEIGHT  HAPPINESSEFFECT  HAPPINESSRADIUS  SUPPLY  NEEDED: ENERGY  HEALTH  GARBAGE  INTERNET  SECURITY                            
				...
				buildingTypes.add(  BUILDINGTYPE_RESEARCHSTATION, new BuildingType(  "BUILDINGTYPE_RESEARCHSTATION", ResourceManager.OBJECT_PLACEHOLDER, ResourceManager.TEXTURE_PLACEHOLDER, ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER, Color.RED,       0,            10,          2,       2,      3,      0,               0,               0,              10,     0,      0,       0,        0        ));
				buildingTypes.add(  BUILDINGTYPE_HANGAR,          new BuildingType(  "BUILDINGTYPE_HANGAR",          ResourceManager.OBJECT_PLACEHOLDER, ResourceManager.TEXTURE_PLACEHOLDER, ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER, Color.RED,       0,            10,          2,       2,      3,      0,               0,               0,              10,     0,      0,       0,        0        ));
				buildingTypes.add(  BUILDINGTYPE_BANK,            new BuildingType(  "BUILDINGTYPE_BANK",            ResourceManager.OBJECT_PLACEHOLDER, ResourceManager.TEXTURE_PLACEHOLDER, ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER, Color.RED,       0,            10,          2,       2,      3,      0,               0,               0,              10,     0,      0,       0,        0        ));
				buildingTypes.add(  BUILDINGTYPE_MEDICALCENTER,   new BuildingType(  "BUILDINGTYPE_MEDICALCENTER",   ResourceManager.OBJECT_PLACEHOLDER, ResourceManager.TEXTURE_PLACEHOLDER, ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER, Color.BLUE,      0,            15,          2,       2,      3,      10,              15,              500,            0,      0,      0,       0,        0        ));
				buildingTypes.add(  BUILDINGTYPE_SERVERCENTER,    new BuildingType(  "BUILDINGTYPE_SERVERCENTER",    ResourceManager.OBJECT_PLACEHOLDER, ResourceManager.TEXTURE_PLACEHOLDER, ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER, Color.BLUE,      0,            10,          2,       2,      3,      0,               0,               1000,           0,      0,      0,       0,        0        ));
				buildingTypes.add(  BUILDINGTYPE_GARBAGEYARD,     new BuildingType(  "BUILDINGTYPE_GARBAGEYARD",     ResourceManager.OBJECT_PLACEHOLDER, ResourceManager.TEXTURE_PLACEHOLDER, ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER, Color.BLUE,      0,            10,          2,       2,      3,      -20,             20,              1000,           0,      0,      0,       0,        0        ));
				buildingTypes.add(  BUILDINGTYPE_POLICE,          new BuildingType(  "BUILDINGTYPE_POLICE",          ResourceManager.OBJECT_PLACEHOLDER, ResourceManager.TEXTURE_PLACEHOLDER, ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER, Color.BLUE,      0,            15,          2,       2,      3,      10,              15,              500,            0,      0,      0,       0,        0        ));
				buildingTypes.add(  BUILDINGTYPE_SOLARPOWER,      new BuildingType(  "BUILDINGTYPE_SOLARPOWER",      ResourceManager.OBJECT_PLACEHOLDER, ResourceManager.TEXTURE_PLACEHOLDER, ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER, Color.YELLOW,    0,            10,          2,       2,      3,      0,               0,               1000,           0,      0,      0,       0,        0        ));
				buildingTypes.add(  BUILDINGTYPE_FUSIONPOWER,     new BuildingType(  "BUILDINGTYPE_FUSIONPOWER",     ResourceManager.OBJECT_PLACEHOLDER, ResourceManager.TEXTURE_PLACEHOLDER, ResourceManager.TEXTURE_GUITHUMBPLACEHOLDER, Color.YELLOW,    0,            60,          2,       2,      3,      0,               0,               10000,          0,      0,      0,       0,        0        ));
	}                                                                                                                                                                                                                                                                                                                                                         
