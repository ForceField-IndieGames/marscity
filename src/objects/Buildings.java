...
public class Buildings{
	...
	public static void init()
	{
		...
		//Building Types:           INDEX                                            NAME                                            OBJECT                                   TEXTURE                                       THUMBNAIL                        GRIDCOLOR        BUILDINGCOST  MONTHLYCOST  WIDTH    DEPTH   HEIGHT  HAPPINESSEFFECT  HAPPINESSRADIUS  T.CATEGORY                       SUPPLY                    ->AMOUNT ->RADIUS  NEEDED: ENERGY  HEALTH  GARBAGE  INTERNET  SECURITY                            
				...
				buildingTypes.add(  BUILDINGTYPE_STREET,          new BuildingType(  "BUILDINGTYPE_STREET",          ResourceManager.OBJECT_STREET,           ResourceManager.TEXTURE_STREET,               ResourceManager.TEXTURE_GUITHUMBSTREET,          Color.BLACK,     5,            0,           1,       1,      0,      0,               0,               TransactionCategory.Other,       null,                     0,       0,       0,      0,      0,       0,        0        ));
